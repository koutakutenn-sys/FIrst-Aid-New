...
public final class ClientEventHandler {
      ...
      if (mc.level == null || mc.player == null || mc.player.connection == null) {
         ...
         if (damageModel instanceof PlayerDamageModel playerDamageModel) {
            ...
            if (wasCriticalRescuable && !canBeRescued) {
               // Just rescued / left critical state — stop residual ringing and heartbeat.
            ...
            if (shouldShowCriticalPrompt && !showedCriticalPrompt) {
               ...
               mc.player.displayClientMessage(Component.translatable("firstaid.gui.self_defib_hint").withStyle(ChatFormatting.YELLOW), false);
            }
   ...
   private static void clearUnconsciousClientInput(net.minecraft.client.player.LocalPlayer player, boolean allowCrawl) {
      ...
      if (mc.options != null) {
         ...
         // Always block reverse/strafe while downed (crawl is forward-only).
   ...
   /**
    * Keeps only the look-forward horizontal component (no reverse / strafe) and clamps speed.
    */
   static net.minecraft.world.phys.Vec3 projectForwardCrawlMotion(
   ...
   public static Component getInteractionPromptTitle() {
      if (interactionPrompt == null) {
         ...
         return switch (interactionPrompt.type()) {
            ...
            case SELF_DEFIB -> Component.translatable("firstaid.gui.self_defib_prompt_title").withStyle(ChatFormatting.AQUA);
      ...
      if (mc.player != null && mc.level != null && mc.player.isAlive()
         ...
         if (defibHand != null) {
            return new ClientEventHandler.InteractionPrompt(
               ...
               mc.screen == null && mc.options.keyUse.isDown(),
               defibHand,
