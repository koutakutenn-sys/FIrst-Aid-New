...
public class DamageablePart extends AbstractDamageablePart {
   ...
   public CompoundTag serializeNBT() {
      ...
      if (this.activeHealer != null) {
         ResourceLocation itemId = BuiltInRegistries.ITEM.getKey(this.activeHealer.stack.getItem());
         if (itemId != null) {
      ...
      if (nbt != null) {
         ...
         if (stack != null) {
            ...
            if (healer == null) {
               ...
               this.activeHealer = healer.loadNBT(nbt.getInt("itemTicks"), nbt.getInt("itemHeals"));
            }
         }
