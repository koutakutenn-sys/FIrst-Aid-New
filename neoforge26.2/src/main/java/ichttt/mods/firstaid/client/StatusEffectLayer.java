    ...
    public void render(GuiGraphicsExtractor guiGraphics, DeltaTracker deltaTracker) {
        ...
        if (damageModel.getUnconsciousTicks() > 0) {
            ...
            if (playerDamageModel != null && playerDamageModel.canGiveUp()) {
                guiGraphics.centeredText(minecraft.font, Component.translatable("firstaid.gui.waiting_for_rescue"), centerX, centerY + 2, opaque(0xE8D9D9));
                guiGraphics.centeredText(minecraft.font, Component.translatable("firstaid.gui.rescue_help"), centerX, centerY + 14, opaque(0xD8CACA));
                guiGraphics.centeredText(minecraft.font, Component.translatable("firstaid.gui.give_up_hint", ClientHooks.GIVE_UP.getTranslatedKeyMessage()), centerX, centerY + 28, opaque(0xFFB3B3));
