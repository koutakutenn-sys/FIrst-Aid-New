...
public class HUDHandler implements ResourceManagerReloadListener, GuiLayer {
    ...
    public void render(GuiGraphicsExtractor guiGraphics, DeltaTracker deltaTracker) {
        ...
        if (minecraft.gui.screen() instanceof ChatScreen && FirstAidConfig.CLIENT.pos.get() == FirstAidConfig.Client.Position.BOTTOM_LEFT) {
        ...
        if (playerModel) {
            ...
            for (AbstractDamageablePart part : damageModel) {
                guiGraphics.text(minecraft.font, translationMap.get(part.part), xOffset, y, 0xFFFFFF);
