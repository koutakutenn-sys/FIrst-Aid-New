...
public final class SuppressionFeedbackController {
    ...
    public void applyCameraAngles(ViewportEvent.ComputeCameraAngles event) {
        ...
        CameraCarrier cameraCarrier = new CameraCarrier(event.getPartialTick(), event.getCamera().getEntity(), suppressionIntensity, shakeStrength);
    ...
    public void onPlaySound(PlaySoundEvent event) {
        ...
        if (INTERNAL_SOUNDS.contains(soundLocation) || original.getSource() == SoundSource.MASTER) {
            return;
        }
