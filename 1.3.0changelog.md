...
- NeoForge 26.2+ crash (NoClassDefFoundError for removed `PlayerInteractEvent.EntityInteractSpecific` event; replaced by modern `PlayerInteractEvent.Action.RIGHT_CLICK_ENTITY` since 1.20.1). Fixes GitHub issue #6.
