...
public class GuiHealthScreen extends Screen {
   ...
   public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
      ...
      guiGraphics.centeredText(this.font, this.title, this.width / 2, this.guiTop + 6, 16777215);
      ...
      if (morphineTicks > 0) {
         ...
         guiGraphics.centeredText(this.font, I18n.get("firstaid.gui.apply_hint", new Object[0]), this.width / 2, this.guiTop + 137 - 22, 16777215);
      }
